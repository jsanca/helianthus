package helianthus.core.access.sql
...
/**
 * Tests [NamedParameterSql] parsing edge cases: simple named parameters,
 * multiple occurrences of the same name, string-literal and comment
 * skipping, PostgreSQL `::` cast handling, and the
 * [NamedParameterSql.hasNamedParameters] fast path.
 */
