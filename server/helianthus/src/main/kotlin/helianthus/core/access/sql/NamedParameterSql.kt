...
object NamedParameterSql {
     ...
     *
     * @property actualSql the rewritten SQL with `?` placeholders in place of `:name` references
     * @property paramNames the ordered list of named parameters as they appeared in the input
     */
