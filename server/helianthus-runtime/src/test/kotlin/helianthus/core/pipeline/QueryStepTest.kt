...
/**
 * Validates [QueryStep]'s SQL execution-plan construction for both
 * positional (`?`) and named (`:name`) parameter styles, including
 * undeclared-name and missing-bound-value error cases.
 */
class QueryStepTest {
