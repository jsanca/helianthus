...
/**
 * End-to-end tests of [Pipeline] driven through the standard step chain
 * (Resolve → Bind → Query → Project → Filter → Limit → ToResultFrame).
 *
 * Uses an in-memory [CloseableRowStream] in place of JDBC to validate the
