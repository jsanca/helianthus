...
/**
 * Verifies that [ProjectStep], [FilterStep], and the underlying column/row
 * resolvers tolerate case differences between declared column names and
 * incoming schema/row keys.
 */
