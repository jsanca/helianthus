...
/**
 * Exercises [FilterOperatorRegistry]'s default operator set: eq, neq, gt,
 * gte, lt, lte, in — including AND-composition of multiple operators on the
 * same cell and unknown-operator error behavior.
 */
