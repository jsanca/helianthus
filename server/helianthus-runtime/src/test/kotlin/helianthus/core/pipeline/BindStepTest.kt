...
/**
 * Tests [BindStep]'s parameter validation and type coercion against an
 * operation with mixed string/number/integer/boolean/date parameters,
 * including missing-required and unparsable-value error cases.
 */
class BindStepTest {
